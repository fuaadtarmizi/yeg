...
export default function App() {
  ...
  function Submit(e) {
    ...
    fetch(
      "https://script.google.com/macros/s/AKfycbzRY6oES6sELtNFdMag6XKmKDYwXHdjQ_O2xUpWljS7n_COAgij4JLvFlAxy9k4KIQh9g/exec",
      {
        method: "POST",
        body: formDatab
      }
      ...
      {isOpen && (
        <div className="w-full right-0 mt-2  origin-top-right bg-white border border-gray-200 divide-y  rounded-md shadow-lg ring-1 ring-black ring-opacity-5">        
          ...
          <p className="px-4 py-2 cursor-pointer hover:bg-yellow-400 rounded-md"
            onClick={() => handleItemClick("Diploma Haji Umrah")}
          >Diploma Haji Umrah</p>
          <p className="px-4 py-2 cursor-pointer hover:bg-yellow-400 rounded-md"
            onClick={() => handleItemClick("Pra-Diploma Haji Umrah")}
          >Pra-Diploma Haji Umrah</p>
          </div>
