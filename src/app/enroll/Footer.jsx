        ...
        <div className="bg-slate-800 pt-10 ">
          ...
          <div className=" col-span-2 p-8">
            ...
            <div className="grid space-y-3">
              ...
              <a className="font-medium text-transparent" href="./kursusdiploma/dacm">Diploma Pengurusan Kargo Udara (DACM)</a>
              <a className="font-medium text-transparent" href="./kursusdiploma/daom">Diploma Pengurusan Operasi Penerbangan (DAOM)</a>
              <a className="font-medium text-transparent" href="./kursusdiploma/damt">Diploma Penyelenggaraan teknologi Pesawat (DAMT)</a>
              <a className="font-medium text-transparent" href="./kursusdiploma/amt">Sijil Kemahiran Malaysia Operasi Penyelenggaraan Pesawat (AMT)</a>
