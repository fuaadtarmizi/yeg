    ...
    <main>        
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 container pt-6 ">
            <div className="space-y-4 p-4 container w-full h-full flex flex-col justify-between">
              <div className="grid space-y-8 ">
                ...
                <h className="font-serif font-bold text-2xl lg:text-5xl">Diploma di Malaysia - Peluang Pendidikan untuk Masa Depan yang Lebih Cerah</h>
                <div className="grid">
        ...
        <section>
          ...
          <div className="container lg:w-2/3  grid space-y-8 py-8">
            <h className=" text-black font-sans">Di Malaysia, program diploma merupakan salah satu laluan pendidikan tinggi yang popular. Program ini memberikan pelajar asas kukuh untuk melangkah ke dunia pekerjaan atau menyambung pengajian ke peringkat yang lebih tinggi. Dengan tempoh pengajian yang singkat dan kos yang berpatutan, diploma menjadi pilihan ideal bagi mereka yang ingin memulakan kerjaya dengan pantas.</h>
            <h className="text-black font-sans">Antara kelebihan utama program diploma ialah fokusnya pada kemahiran praktikal yang relevan dengan keperluan industri. Pelajar diajar kemahiran khusus dalam bidang seperti perniagaan, kejuruteraan, teknologi maklumat, seni kulinari, dan banyak lagi. Ini menjadikan graduan diploma lebih bersedia untuk memenuhi kehendak pasaran kerja.</h>
          </div>
          </div>
        </section>
        <section>
        ...
        <div className="container lg:w-2/3 grid space-y-8">
          <h className="font-sans ">Malaysia menawarkan pelbagai jenis diploma yang diiktiraf oleh Agensi Kelayakan Malaysia (MQA). Beberapa program yang popular termasuk Diploma Pengurusan Perniagaan, Diploma Kejuruteraan, Diploma Teknologi Maklumat (IT), dan Diploma Pengurusan Haji dan Umrah. Program-program ini disediakan oleh institusi terkemuka seperti Universiti Teknologi MARA (UiTM), Politeknik Malaysia, dan YEG Academy.</h>
          <h className="font-sans ">Bagi memilih program diploma yang tepat, penting untuk mempertimbangkan minat dan matlamat kerjaya anda. Pilih kursus yang sesuai dengan keperluan pasaran dan reputasi institusi yang menawarkan program tersebut. Dengan akreditasi MQA, anda boleh yakin bahawa kelayakan yang diperoleh diiktiraf secara meluas di Malaysia dan di peringkat antarabangsa.</h>
          <h className="font-sans ">Kesimpulannya, diploma di Malaysia adalah pilihan pendidikan yang praktikal dan berbaloi. Ia menyediakan peluang untuk membina asas kerjaya yang kukuh dengan pelbagai laluan ke arah kejayaan. Dengan program diploma yang pelbagai dan relevan, pelajar dapat melangkah ke masa depan yang cerah dan bermakna.
