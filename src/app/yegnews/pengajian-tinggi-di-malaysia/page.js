    ...
    <main>        
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 container pt-6 ">
            <div className="space-y-4 p-4 container w-full h-full flex flex-col justify-between">
              <div className="grid space-y-8 ">
                ...
                <h className="font-serif font-bold text-2xl lg:text-5xl">YEG Academy: Peluang Pendidikan Diploma Terbaik untuk Masa Depan Anda</h>
                <div className="grid">
        ...
        <section>
          ...
          <div className="container lg:w-2/3  grid space-y-8 py-8">
            <h className=" text-black font-sans">YEG Academy merupakan salah satu institusi pendidikan terkemuka di Malaysia yang menyediakan peluang pendidikan diploma terbaik untuk pelajar yang ingin memajukan kerjaya mereka. Dengan fokus pada pembangunan kemahiran praktikal dan teori, YEG Academy membantu pelajar membina asas kukuh untuk masa depan yang cerah dalam pelbagai bidang profesional.</h>
            <h className="text-black font-sans">Salah satu kelebihan utama di YEG Academy ialah pelbagai program diploma yang relevan dengan keperluan industri semasa. Program seperti Pengurusan Haji dan Umrah (DHUMY) telah melahirkan graduan yang berjaya dalam sektor pelancongan Islamik. Dengan kurikulum yang direka khas untuk memenuhi keperluan pasaran kerja, YEG Academy memberikan peluang kepada pelajar untuk mendapatkan pengetahuan mendalam serta pengalaman praktikal yang sangat berharga.</h>
          </div>
          </div>
        </section>
        <section>
        ...
        <div className="container lg:w-2/3 grid space-y-8">
          <h className="font-sans ">Di YEG Academy, pelajar dibimbing oleh tenaga pengajar yang berpengalaman dan berdedikasi. Akademi ini juga menawarkan kemudahan pembelajaran moden seperti makmal praktikal dan bilik kuliah yang dilengkapi teknologi terkini. Selain itu, suasana pembelajaran yang kondusif di YEG Academy memastikan setiap pelajar dapat mencapai potensi maksimum mereka sepanjang pengajian.</h>
          <h className="font-sans ">Program diploma di YEG Academy diiktiraf oleh Agensi Kelayakan Malaysia (MQA), menjadikan sijil yang diperoleh diiktiraf secara meluas. Akreditasi ini membuka peluang luas untuk graduan YEG Academy menyambung pengajian mereka ke peringkat lebih tinggi atau terus memasuki pasaran kerja dengan keyakinan tinggi. Graduan YEG Academy sering menjadi pilihan majikan kerana kemahiran mereka yang praktikal dan relevan.</h>
          <h className="font-sans ">Jika anda sedang mencari peluang pendidikan diploma yang terbaik untuk membina kerjaya yang cemerlang, YEG Academy adalah pilihan yang tepat. Dengan program diploma yang pelbagai, tenaga pengajar berkaliber, dan pengiktirafan antarabangsa, YEG Academy adalah platform unggul untuk memulakan perjalanan ke arah masa depan yang lebih cerah
