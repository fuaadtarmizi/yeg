...
import Formblastingmisa from '@/components/misa/Formblastingmisa'
    ...
    <section id="target-section">
      <div className="w-full bg-slate-300 p-4 rounded-sm">
        <div className=" grid justify-center">
          ...
          <a href="https://wa.me/+601115403660" className="bg-green-500 hover:bg-green-400 motion-safe:transition-all motion-safe:duration-700 ease-in-out flex items-center justify-center px-4 w-full border-2 border-black rounded-full">
        ...
        <div className="flex space-x-2 pt-4">
          ...
          <a href="tel:+601115403660" className="bg-red-500 hover:bg-red-400 motion-safe:transition-all motion-safe:duration-700 ease-in-out flex items-center justify-center px-4 w-full border-2 border-black rounded-full">
