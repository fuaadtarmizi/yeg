  ...
  return (
    ...
    <section>
      ...
      <div className="flex space-x-2">
        ...
        <a href="tel:+601115403660" className="hover:bg-red-600 motion-safe:transition-all motion-safe:duration-700 ease-in-out flex items-center justify-center px-4 w-full border-2 border-black rounded-full">
          <h className="text-lg font-bold">PERTANYAAN LANJUT</h>
        </a>
      </div>
      </div>      
      </div>
