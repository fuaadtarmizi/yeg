  ...
  return (
    ...
    <div className=" px-4 lg:px-16 ">
      ...
      <div className="">
        ...
        <button className="group  ">
          <span className="font-sans text-gray-600">Klik untuk program-program lain</span>
    ...
    <div className="lg:px-28 px-4">
      ...
      <div className="">
        ...
        <button className="group ">
          <div className="flex items-center ">
          <span className=" font-sans  font-semibold hover:text-white "> Ketahui lebih lanjut</span>
      ...
      <div className="w-full h-full px-4 lg:px-28 ">
        ...
        <card1 className="w-full h-full flex justify-center items-center rounded-md hover:shadow-xl  group " style={{ backgroundImage: 'url("/newss2.jpg")', backgroundSize: 'cover', backgroundPosition: 'fit' }}>
          ...
          <div className="h-full grid items-end ">
            <button className="text-left group-hover:bg-white p-2 group-hover:-translate-y-3 transition duration-500">
