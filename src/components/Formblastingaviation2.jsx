...
export default function App() {
  ...
  function Submit(e) {
    ...
    fetch(
      "https://script.google.com/macros/s/AKfycbyKZMxYtdIlCBrLxAK9jzoOAmDVduF47Ur_6AUtocSQygIDMYAipW1QyuS0QdQH1SVK/exec",
      {
        method: "POST",
        body: formDatab
      }
    ...
    <div>
      ...
      {isOpen3 && (
        <div className="w-full right-0 mt-2  origin-top-right bg-white border border-gray-200 divide-y  rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
          ...
          <div className="pl-6 text-sm bg-yellow-500">
          <p className="px-4 py-2 cursor-pointer hover:bg-yellow-400 rounded-md"
            onClick={() => handleItemClick3("DIPLOMA PENGURUSAN KARGO UDARA (DACM-WBL)")}
          >
            DIPLOMA PENGURUSAN KARGO UDARA (DACM-WBL)
          </p>
          <p className="px-4 py-2 cursor-pointer hover:bg-yellow-400 rounded-md"
            onClick={() => handleItemClick3("DIPLOMA PENGURUSAN OPERASI PENERBANGAN (DAOM-WBL)")}
          >
            DIPLOMA PENGURUSAN OPERASI PENERBANGAN (DAOM-WBL)
          </p>
          <p className="px-4 py-2 cursor-pointer hover:bg-yellow-400 rounded-md"
            onClick={() => handleItemClick3("DIPLOMA TEKNOLOGI PEMBAIKAN STRUKTUR PESAWAT - KEPINGAN LOGAM (DASM-WBL)")}
          >
            DIPLOMA TEKNOLOGI PEMBAIKAN STRUKTUR PESAWAT - KEPINGAN LOGAM (DASM-WBL)
          </p>
          </div>
          ...
          <div className="pl-6 text-sm text-white bg-slate-600">
          <p className="px-4 py-2 cursor-pointer hover:bg-slate-400 rounded-md"
            onClick={() => handleItemClick3("DIPLOMA PENGURUSAN KARGO UDARA (DACM)")}
          >
            DIPLOMA PENGURUSAN KARGO UDARA (DACM)
          </p>
          <p className="px-4 py-2 cursor-pointer hover:bg-slate-400 rounded-md"
            onClick={() => handleItemClick3("DIPLOMA PENGURUSAN OPERASI PENERBANGAN (DAOM)")}
          >
            DIPLOMA PENGURUSAN OPERASI PENERBANGAN (DAOM)
          </p>
          <p className="px-4 py-2 cursor-pointer hover:bg-slate-400 rounded-md"
            onClick={() => handleItemClick3("DIPLOMA AIRCRAFT MAINTAINANCE TECHNOLOGY (DAMT")}
          >
            DIPLOMA AIRCRAFT MAINTAINANCE TECHNOLOGY (DAMT)
          </p>
          <p className="px-4 py-2 cursor-pointer hover:bg-slate-400 rounded-md"
            onClick={() => handleItemClick3("SIJIL KEMAHIRAN MALAYSIA OPERASI PENYELENGGARAAN PESAWAT (AMT)")}
          >
            SIJIL KEMAHIRAN MALAYSIA OPERASI PENYELENGGARAAN PESAWAT (AMT)
          </p>
          </div>
          ...
          <div className="pl-6 text-sm bg-gray-400">
          <p className=" py-2 cursor-pointer hover:bg-gray-500 rounded-md"
            onClick={() => handleItemClick3("AVIATION - CABIN CREW")}
          >
            AVIATION - CABIN CREW
          </p>
          <p className="py-2 cursor-pointer hover:bg-gray-500 rounded-md"
            onClick={() => handleItemClick3("AVIATION - CUSTOMER SERVICE")}
          >
            AVIATION - CUSTOMER SERVICE
          </p>
          <p className="py-2 cursor-pointer hover:bg-gray-500 rounded-md"
            onClick={() => handleItemClick3("AVIATION - GROUND HANDLING")}
          >
            AVIATION - GROUND HANDLING
          </p>
          <p className="py-2 cursor-pointer hover:bg-gray-500 rounded-md"
            onClick={() => handleItemClick3("AVIATION - TICKETING")}
          >
            AVIATION - TICKETING
          </p>
          </div>
    ...
    <div>
      ...
      {isOpen4 && (
        <div className="w-full right-0 mt-2  origin-top-right bg-white border border-gray-200 divide-y  rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
          ...
          <div className="pl-6 text-sm bg-yellow-500">
          <p className="px-4 py-2 cursor-pointer hover:bg-yellow-400 rounded-md"
            onClick={() => handleItemClick4("DIPLOMA PENGURUSAN KARGO UDARA (DACM-WBL)")}
          >
            DIPLOMA PENGURUSAN KARGO UDARA (DACM-WBL)
          </p>
          <p className="px-4 py-2 cursor-pointer hover:bg-yellow-400 rounded-md"
            onClick={() => handleItemClick4("DIPLOMA PENGURUSAN OPERASI PENERBANGAN (DAOM-WBL)")}
          >
            DIPLOMA PENGURUSAN OPERASI PENERBANGAN (DAOM-WBL)
          </p>
          <p className="px-4 py-2 cursor-pointer hover:bg-yellow-400 rounded-md"
            onClick={() => handleItemClick4("DIPLOMA TEKNOLOGI PEMBAIKAN STRUKTUR PESAWAT - KEPINGAN LOGAM (DASM-WBL)")}
          >
            DIPLOMA TEKNOLOGI PEMBAIKAN STRUKTUR PESAWAT - KEPINGAN LOGAM (DASM-WBL)
          </p>
          </div>
          ...
          <div className="pl-6 text-sm text-white bg-slate-600">
          <p className="px-4 py-2 cursor-pointer hover:bg-slate-400 rounded-md"
            onClick={() => handleItemClick4("DIPLOMA PENGURUSAN KARGO UDARA (DACM)")}
          >
            DIPLOMA PENGURUSAN KARGO UDARA (DACM)
          </p>
          <p className="px-4 py-2 cursor-pointer hover:bg-slate-400 rounded-md"
            onClick={() => handleItemClick4("DIPLOMA PENGURUSAN OPERASI PENERBANGAN (DAOM)")}
          >
            DIPLOMA PENGURUSAN OPERASI PENERBANGAN (DAOM)
          </p>
          <p className="px-4 py-2 cursor-pointer hover:bg-slate-400 rounded-md"
            onClick={() => handleItemClick4("DIPLOMA AIRCRAFT MAINTAINANCE TECHNOLOGY (DAMT")}
          >
            DIPLOMA AIRCRAFT MAINTAINANCE TECHNOLOGY (DAMT)
          </p>
          <p className="px-4 py-2 cursor-pointer hover:bg-slate-400 rounded-md"
            onClick={() => handleItemClick4("SIJIL KEMAHIRAN MALAYSIA OPERASI PENYELENGGARAAN PESAWAT (AMT)")}
          >
            SIJIL KEMAHIRAN MALAYSIA OPERASI PENYELENGGARAAN PESAWAT (AMT)
          </p>
          </div>
          ...
          <div className="pl-6 text-sm bg-gray-400">
          <p className=" py-2 cursor-pointer hover:bg-gray-500 rounded-md"
            onClick={() => handleItemClick4("AVIATION - CABIN CREW")}
          >
            AVIATION - CABIN CREW
          </p>
          <p className="py-2 cursor-pointer hover:bg-gray-500 rounded-md"
            onClick={() => handleItemClick4("AVIATION - CUSTOMER SERVICE")}
          >
            AVIATION - CUSTOMER SERVICE
          </p>
          <p className="py-2 cursor-pointer hover:bg-gray-500 rounded-md"
            onClick={() => handleItemClick4("AVIATION - GROUND HANDLING")}
          >
            AVIATION - GROUND HANDLING
          </p>
          <p className="py-2 cursor-pointer hover:bg-gray-500 rounded-md"
            onClick={() => handleItemClick4("AVIATION - TICKETING")}
          >
            AVIATION - TICKETING
          </p>
          </div>
