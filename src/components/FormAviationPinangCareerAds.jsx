...
export default function App() {
  ...
  function Submit(e) {
    ...
    fetch(
      ...
      "https://script.google.com/macros/s/AKfycbwCXkTQ0_Im3HNKhMUEBVw_niwH-AJiHxBY0ooPQw8qiFQyrWRGi_ienr2atqQdOIsi-w/exec",
      {
        method: "POST",
        body: formDatab
      }
    ...
    <div className=" hidden lg:block"></div>
      ...
      {isOpen && (
        <div className="w-full right-0 mt-2  origin-top-right bg-white border border-gray-200 divide-y  rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
          ...
          <p className="px-4 py-2 cursor-pointer hover:bg-yellow-400 rounded-md"
            onClick={() => handleItemClick("AVIATION - CUSTOMERS SERVICE")}
          >
            AVIATION - CUSTOMERS SERVICE
          </p>
          <p className="px-4 py-2 cursor-pointer hover:bg-yellow-400 rounded-md"
