...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyqCt_CrQpJF2kQ_W-hvwconZIs0kUvExIuJv0Eya_vQThwKfx6pHFna2-NHIWr6Ank/exec";

export default function FormMPHUKelantan() {
  // Form field values
      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.field}>
           ...
           <div style={styles.field}>
            <label style={styles.label}>Pilih Negeri*</label>
            <select
              style={styles.input}
              name="State"
