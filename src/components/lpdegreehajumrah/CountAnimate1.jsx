...
const CountAnimate1 = () => {
  ...
  useEffect(() => {
    ...
    if (isVisible) {
      ...
      timer = setInterval(updateCount, 5); // Update every 100 milliseconds
    } else {
      countRef.current = 1900; // Reset count when not visible
    }
  ...
  return (
      ...
      <div className="flex justify-end w-full">
        ...
        <h1 className="text-2xl font-semibold ">Sejak</h1>
        <h1 className="text-2xl font-normal text-slate-500">Ditubuhkan</h1>
        </div> 
      </div>
  );
};
export default CountAnimate1;
